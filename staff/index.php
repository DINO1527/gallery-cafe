...
<head>
    ...
    <link rel="stylesheet" href="/gallarycafe/admin/styles.css">
</head>
    ...
    <div class="profile">
            ...
            <h3 id="admin-name">Staff Dashboard</h3>
    ...
    confirmLogoutBtn.addEventListener('click', () => {
        ...
        window.location.href = '/gallarycafe/staff/login/logout.php';
    });

    cancelLogoutBtn.addEventListener('click', () => {
        // Navigate back to home page
        document.querySelector('.sidebar nav ul li.active').classList.remove('active');
        document.querySelector('.sidebar nav ul li[data-page="home"]').classList.add('active');
        pages.forEach(page => page.classList.remove('active'));
        ...
        if (tdCustomer || tdBooking) {
            ...
            if (txtValueCustomer.toUpperCase().indexOf(filter) > -1 || txtValueBooking.toUpperCase().indexOf(filter) > -1) {
                tr[i].style.display = ""; // Show the row if it matches the search query
                    ...
                    <?php require_once($_SERVER['DOCUMENT_ROOT'] . '/gallarycafe/staff/odercon/odercon.php');
?>

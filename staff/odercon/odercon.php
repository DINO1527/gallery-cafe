  ...
  <section id="order-confirmation" class="page">
                ...
                <div class="order-grid">
                    <!-- Sample Order Row -->
                    <?php include 'odercon/fetch_orders.php'; ?>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateOrderStatus(orderId, statusId) {
        ...
        xhr.open('POST', '/gallarycafe/staff/odercon/update_order_status.php', true);
        xhr.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
        xhr.onload = function () {
            if (xhr.status === 200) {
                alert('Order status updated successfully');
                location.reload(); // Reload to reflect changes
                window.location.href = '/gallarycafe/staff/index.php';
            } else {
